...
| ✅ V6.5 — Profiling & Optimization | done — `core/FrameStats.hpp` + an on-screen FPS/ms readout and budget-colored frame-time graph; the skinning hot path is profiled with a ScopedTimer. | v5.5.0 |
